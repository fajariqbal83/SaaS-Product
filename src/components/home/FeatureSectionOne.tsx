						...
						<div className="relative w-full max-w-130">
							...
							<div className="bg-white shadow-xl rounded-3xl overflow-hidden w-full">
								<img src={
									...
									alt="Growth"
									className=" w-full h-125 sm:h-150 md:h-170 lg:h-175 object-cover rounded-l-3xl "/>
							</div>
							...
							{/* Analytics Card */}
							<div className="absolute top-24 sm:top-28 md:top-32 left-1/2 sm:left-[80%]  -translate-x-1/2  sm:-translate-x-1/2 bg-white rounded-2xl shadow-xl  p-4 sm:p-6 md:p-8  w-55 sm:w-70 md:w-85  z-10">
